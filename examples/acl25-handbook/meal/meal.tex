...
$\dagger$$\dagger$: Included in the Main Conference registration only, and can be added on for Guests, Tutorials, Workshops, and Exhibitors to attend at the Registration Solutions Desk or through your Events registration login. \textbf{No admission without an entry ticket}
...
\begin{center}
\includegraphics[width=1.0\linewidth]{examples/acl25-handbook/meal/meal_info.pdf}
\end{center}
