...
\section{ACL 2025 Findings Reception}
\vspace*{0.2cm}

Venue: Austria Center Vienna, Level 0 Hall X4 X5 \\
Time: Monday, July 28, 2025 18:00 - 19:00\\

Join us for an engaging evening as we kick off the evening with a relaxed reception featuring light snacks and refreshments. Mingle with fellow attendees, enjoy a drink, and explore the poster presentations showcasing innovative findings. It’s the perfect setting to connect, collaborate, and spark ideas.\\

\textbf{Important Information}:\\
\textbf{Attendance is included} for all Main Conference registrants only.\\
