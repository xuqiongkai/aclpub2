...
% Day 1 %
%%%%%%%%%%%%
\setheaders{Day 1: Monday 28 July}{Day 1: Monday 28 July}
\chapter{Day 1: Monday 28 July}

\section{Oral Presentation}
\BLOCK{for session in orals[0]}
\subsection*{{\VAR{session.name} (\VAR{session.date}, \VAR{session.time}, \VAR{session.location})}}
  \BLOCK{for paper in session.papers}
    {\VAR{paper.time}}
\begin{large}
\begin{Verbatim}
\VAR{paper.title}
...
\BLOCK{for session in posters[0]}
\subsection*{{\VAR{session.name} (\VAR{session.date}, \VAR{session.time}, \VAR{session.location})}}
  \BLOCK{for paper in session.papers}
    {\VAR{paper.time}}
\begin{large}
...
\section{Virtual Presentation}
\BLOCK{for session in virtuals[0]}
\subsection*{{\VAR{session.name} (\VAR{session.date}, \VAR{session.time}, \VAR{session.location})}}
  \BLOCK{for paper in session.papers}
    {\VAR{paper.time}}
\begin{large}
...
% Day 2 %
%%%%%%%%%%%%
\setheaders{Day 2: Tuesday 29 July}{Day 2: Tuesday 29 July}
\chapter{Day 2: Tuesday 29 July}

\section{Oral Presentation}
\BLOCK{for session in orals[1]}
\subsection*{{\VAR{session.name} (\VAR{session.date}, \VAR{session.time}, \VAR{session.location})}}
  \BLOCK{for paper in session.papers}
    {\VAR{paper.time}}
\begin{large}
...
\section{Poster Presentation}
\BLOCK{for session in posters[1]}
\subsection*{{\VAR{session.name} (\VAR{session.date}, \VAR{session.time}, \VAR{session.location})}}
  \BLOCK{for paper in session.papers}
    {\VAR{paper.time}}
\begin{large}
...
\section{Virtual Presentation}
\BLOCK{for session in virtuals[1]}
\subsection*{{\VAR{session.name} (\VAR{session.date}, \VAR{session.time}, \VAR{session.location})}}
  \BLOCK{for paper in session.papers}
    {\VAR{paper.time}}
\begin{large}
...
% Day 3 %
%%%%%%%%%%%%
\setheaders{Day 3: Wednesday 30 July}{Day 3: Wednesday 30 July}
\chapter{Day 3: Wednesday 30 July}

\section{Oral Presentation}
\BLOCK{for session in orals[2]}
\subsection*{{\VAR{session.name} (\VAR{session.date}, \VAR{session.time}, \VAR{session.location})}}
  \BLOCK{for paper in session.papers}
    {\VAR{paper.time}}
\begin{large}
...
\section{Poster Presentation}
\BLOCK{for session in posters[2]}
\subsection*{{\VAR{session.name} (\VAR{session.date}, \VAR{session.time}, \VAR{session.location})}}
  \BLOCK{for paper in session.papers}
    {\VAR{paper.time}}
\begin{large}
...
\section{Virtual Presentation}
\BLOCK{for session in virtuals[2]}
\subsection*{{\VAR{session.name} (\VAR{session.date}, \VAR{session.time}, \VAR{session.location})}}
  \BLOCK{for paper in session.papers}
    {\VAR{paper.time}}
\begin{large}
