...
def load_configs_handbook(root: Path):
    ...
    virtuals = [load_config("program_virtual/program_virtual_day1", root), load_config("program_virtual/program_virtual_day2", root), load_config("program_virtual/program_virtual_day3", root)]
    return (
        conference,
        papers,
        sponsors,
